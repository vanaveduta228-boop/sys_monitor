...
class TestSystemMonitor(unittest.TestCase):
    ...
    def test_cpu_alert_trigger(self):
        ...
        config = {"cpu_limit": 80, "ram_limit": 90, "disk_min_gb": 10, "net_limit_gb": 100, "battery_min_percent": 20,"server_to_check":"google.com:80"}
    ...
    def test_cpu_recovery(self):
        ...
        config = {"cpu_limit": 80, "ram_limit": 90, "disk_min_gb": 10, "net_limit_gb": 100, "battery_min_percent": 20,"server_to_check":"google.com:80"}
        alert_states = {"cpu": True, "ram": False, "disk": False, "net": False, "battery": False,"net_port":False}
        check_thresholds(metrics, config, alert_states)
    ...
    def test_ram_recovery(self):
        metrics = {"cpu": 50, "ram": 50, "disk": 100, "net_sent": 10, "net_recv": 10, "battery_percent": 80, "is_plugged": True}
        config = {"cpu_limit": 80, "ram_limit": 90, "disk_min_gb": 10, "net_limit_gb": 100, "battery_min_percent": 20,"server_to_check":"google.com:80"}
        alert_states = {"cpu": False, "ram": True, "disk": False, "net": False, "battery": False,"net_port":False}
        check_thresholds(metrics, config, alert_states)
